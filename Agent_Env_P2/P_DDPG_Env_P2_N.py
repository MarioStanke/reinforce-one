...
class P_Env_P2_N(py_environment.PyEnvironment):
    ...
    def plot_actions_and_states(self):
        ...
        p1.plot(t, n_tests, color='black', label = 'Av. Number of Tests', marker = '.', linestyle = '-')
        p2.plot(t, n_replace, color='black', label = 'Number of Replacements', marker = '.', linestyle = '-')
        p3.plot(t, av_infectious, color='red', label = 'Percentage of Infectious', marker = '.', linestyle = '-')
        p1.legend()
        p2.legend()
        p3.legend()
